...
//        Log.e("看看传进来的日期",":"+mynow.get(Calendar.YEAR) + mynow.get(Calendar.MONTH)+mynow.get(Calendar.DAY_OF_MONTH));
...
//                Toast.makeText(context, "长按了Group:" + groupItem.getData("name"), Toast.LENGTH_SHORT).show();
    ...
    //判断事件是否连续,连续为true(除去第一天)
    private boolean isContinuous(Event o1) {
//        Log.e("","看一下當前事件的值"+"day"+o1.getStartDayOfMonth()+ o1.getEndDayOfMonth() +
//                "month"+o1.getStartMonth() +" "+o1.getEndMonth() +"year"+
//                o1.getStartYear() +o1.getEndYear());
//
//        Log.e("看一下now的值",""+""+now.get(Calendar.DAY_OF_MONTH) +now.get(Calendar.MONTH)
