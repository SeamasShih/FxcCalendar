...
public class SearchEventActivity extends AppCompatActivity {
    ...
    public static final String INTENT_EVENT_SEARCH_TYPE = "event_type";
    public static final String INTENT_NORMAL_EVENT = "normal";
    public static final String INTENT_NO_TIME_EVENT = "no_time";
    ...
    private void getIntentInfo() {
        ...
        searchType = intent.getStringExtra(INTENT_EVENT_SEARCH_TYPE);
    }
    ...
    private ArrayList<Object> getSearchEventList() {
        ...
        for (int i = 0; i < events.size(); i++) {
            ...
            if (event.getTitle().contains(string) && isEventColorBeSelected(event))
    ...
    private ArrayList<Object> getSearchEventListByColor() {
        String string = searchText.getText().toString();
        list.clear();
        if (colors.size() == 0)
            return list;
    ...
    private boolean isEventColorBeSelected(Event event) {
        if (colors.size() == 0)
            return true;
    ...
    private void showColorLabelSearch() {
        ...
        SearchLabelPopupWindow popupWindow = new SearchLabelPopupWindow(this, parent, getWindow().getDecorView().getWidth(),  getWindow().getDecorView().getHeight()/4);
        ...
        popupWindow.setOnColorSearchSelectListener(new SearchLabelPopupWindow.OnColorSearchSelectListener() {
            ...
            public void onSelect(ArrayList<Integer> colors) {
                SearchEventActivity.this.colors = colors;
                list = getSearchEventListByColor();
                searchRecyclerViewAdapter.notifyDataSetChanged();
            }
        });
        ...
        popupWindow.setSelectColors(colors);
