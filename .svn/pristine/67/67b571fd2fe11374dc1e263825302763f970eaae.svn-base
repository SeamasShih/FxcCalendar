...
public class Event implements Parcelable {
    ...
    public Event(String title, int startYear, int startMonth, int startDayOfMonth, int startHour, int startMinute, int endYear, int endMonth, int endDayOfMonth, int endHour, int endMinute, boolean isAllDay, int color, int repeat, boolean isComplete, int groupId, String note, String map, String url, boolean isNoTime, String objectId) {
        this.title = title;
