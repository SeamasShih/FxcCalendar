...
public class AgendaDayEvent implements Comparable<AgendaDayEvent> {
    public static final String LABEL_IN_DAY = "se_";
    public static final String LABEL_START_DAY = "s_";
    public static final String LABEL_END_DAY = "e_";
    public static final String LABEL_ALL_DAY = "a_";
    ...
    public ArrayList<AgendaEvent> getEvents() {
        return arrayList;
    }
    ...
    public class AgendaEvent implements Comparable<AgendaEvent> {
        ...
        public String getStartTime() {
            switch (label) {
                case LABEL_IN_DAY:
                case LABEL_START_DAY:
                    return event.getStartHour() + ":" + doubleDigit(event.getStartMinute());
                case LABEL_END_DAY:
                    return " 0:00";
                default:
        ...
        public String getEndTime() {
            switch (label) {
                case LABEL_IN_DAY:
                case LABEL_END_DAY:
                    return event.getEndHour() + ":" + doubleDigit(event.getEndMinute());
                case LABEL_START_DAY:
                    return " 0:00";
                default:
                    return null;
        ...
        public boolean isComplete() { return  event.isComplete();}

        public boolean isRemind() {return Data.getInstance().isRemind(event);
        }
