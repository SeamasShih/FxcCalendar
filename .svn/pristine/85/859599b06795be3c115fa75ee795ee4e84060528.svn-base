...
public class KeepEventAdapter extends RecyclerView.Adapter<KeepEventAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull KeepEventAdapter.MyHolder myHolder, int position) {
        ...
        if(keepEvent.get(position).isComplete()){
            myHolder.keepEventTitle.getPaint().setFlags(Paint. STRIKE_THRU_TEXT_FLAG);
            myHolder.cardView.setCardElevation(0);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            ...
            imageView= itemView.findViewById(R.id.iv_keep_completed);
        }
    }
}
